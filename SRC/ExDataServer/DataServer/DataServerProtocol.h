...
// CMS GS item delivery queue. Keep this packet mirrored with GameServer/DSProtocol.h.
...
struct SDHP_SYSTEM_CACHE_REBUILD_SEND
{
	PBMSG_HEAD header; // C1:F3:99
	int index;
	char account[11];
};
...
void GDSysCacheRebuildRecv(SDHP_SYSTEM_CACHE_REBUILD_SEND* lpMsg);
