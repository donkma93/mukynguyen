...
void CCustomBuyVip::BuyVipDone(LPOBJ lpObj)
{
	...
	{
		lpObj->BuyVip = 0;
		gNotice.GCNoticeSend(lpObj->Index, 1, 0, 0, 0, 0, 0, gMessageNew.GetMessage(557));
		return;
	}
	...
	gNotice.GCNoticeSend(lpObj->Index, 1, 0, 0, 0, 0, 0, gMessageNew.GetMessage(558), VipInfo->VipName);
