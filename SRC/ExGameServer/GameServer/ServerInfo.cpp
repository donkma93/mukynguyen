...
void CServerInfo::ReadCommonInfo()
{
	...
	gMessageNew.LoadConfig(gPath.GetFullPath("Message.xml"));

	LogAdd(LOG_BLUE,"[ServerInfo] Common loaded successfully");
}
//Reload ACuoi
void CServerInfo::ReloadCfgSPK()
{
	gBlackList.Load(gPath.GetFullPath("BlackList.txt"));
	g_ExWinQuestSystem.Load();
	gAddBuffer.Read(gPath.GetFullPath("Custom\\AddBuff.txt"));
	gCustomMonsterSkill.Load(gPath.GetFullPath("Custom\\CustomMonsterSkill.txt"));
	gNewCashShop.LoadFileXML(gPath.GetFullPath("Custom\\ThangCuoi\\CustomShop.xml"));
	LogAdd(LOG_BLUE, "[ServerInfo] CfgACuoi loaded successfully");
}
...
void CServerInfo::ReadCustomInfo()
{
	...
	gCBMocNap.LoadFileXML(gPath.GetFullPath("Custom\\ThangCuoi\\CustomMocNap.xml"));
	...
	gCustomStartItem.Load(gPath.GetFullPath("Custom\\ThangCuoi\\CustomStartItem\\CustomStartItem.txt"));
	gCustomStartItemDame.LoadItemDame(gPath.GetFullPath("Custom\\ThangCuoi\\CustomStartItem\\CustomStartItemDame.txt"));
	...
	gCustomJewelBank.LoadConfig(gPath.GetFullPath("Custom\\ThangCuoi\\NganHangNgoc.xml"));
	gTaiSinh.Load(gPath.GetFullPath("Custom\\ThangCuoi\\Relife.xml"));
	gResetChange.Load(gPath.GetFullPath("Custom\\ThangCuoi\\ResetDoiQua.txt"));
	gDanhHieu.LoadConfig(gPath.GetFullPath("Custom\\ThangCuoi\\Rank\\DanhHieu.xml"));
	gQuanHam.LoadConfig(gPath.GetFullPath("Custom\\ThangCuoi\\Rank\\QuanHam.xml"));
	gTuLuyen.LoadConfig(gPath.GetFullPath("Custom\\ThangCuoi\\Rank\\TuLuyen.xml"));
	gHonHoan.LoadConfig(gPath.GetFullPath("Custom\\ThangCuoi\\Rank\\HonHoan.xml"));
	gCustomGift.LoadConfig(gPath.GetFullPath("Custom\\ThangCuoi\\GiftCodeTanThu.xml"));
...
void CServerInfo::ReadEventInfo()
{
	...
	gCastleStartGuild.Load(gPath.GetFullPath("Event\\CTCMini\\CongThanhChien.xml"));
	gCastleStartGuild.Init();
...
void CServerInfo::ReloadBotInfo()
{
	...
	LogAdd(LOG_BLUE,"[ReadBotInfo] BotSystem loaded successfully");
}
//MC bot
...
void CServerInfo::ReadStartupInfo(char* section,char* path)
{
	...
	GetPrivateProfileString(section,"CustomerKeyVersion","",this->m_CustomerKeyVersion,sizeof(this->m_CustomerKeyVersion),path);
...
void CServerInfo::ReadCommandInfo(char* section,char* path)
{
	...
	this->m_CommandResetAutoEnable[0] = GetPrivateProfileInt(section,"CommandResetVipAutoEnable_AL0",0,path);
	this->m_CommandResetAutoEnable[1] = GetPrivateProfileInt(section,"CommandResetVipAutoEnable_AL1",0,path);
	this->m_CommandResetAutoEnable[2] = GetPrivateProfileInt(section,"CommandResetVipAutoEnable_AL2",0,path);
	this->m_CommandResetAutoEnable[3] = GetPrivateProfileInt(section,"CommandResetVipAutoEnable_AL3",0,path);

	this->m_CommandResetVipAutoEnable[0] = GetPrivateProfileInt(section,"CommandResetAutoEnable_AL0",0,path);
	this->m_CommandResetVipAutoEnable[1] = GetPrivateProfileInt(section,"CommandResetAutoEnable_AL1",0,path);
	this->m_CommandResetVipAutoEnable[2] = GetPrivateProfileInt(section,"CommandResetAutoEnable_AL2",0,path);
	this->m_CommandResetVipAutoEnable[3] = GetPrivateProfileInt(section,"CommandResetAutoEnable_AL3",0,path);
...
void CServerInfo::ReadCommonInfo(char* section, char* path)
{
	...
	this->m_ServerAdmin = GetPrivateProfileInt(section, "ServerAdmin", 0, path);
	this->m_ServerLock = GetPrivateProfileInt(section, "ServerLock", 0, path);
	this->m_ServerMaxUserNumber = GetPrivateProfileInt(section, "ServerMaxUserNumber", 0, path);
	...
	this->m_SetInventoryCoin = GetPrivateProfileInt(section, "SetInventoryCoin", 0, path);
	...
	this->m_RenderDameBossDelay = GetPrivateProfileInt(section, "RenderTimeDamageDelay", 0, path);
	this->m_RenderDameBossClear = GetPrivateProfileInt(section, "RenderTimeDamageBoss", 0, path);
...
#if(ACuoi_NPC_Buff)
	this->m_TimeBuff = GetPrivateProfileInt(section, "TimeBuf", 0, path);

	this->m_Buff1 = GetPrivateProfileInt(section, "Buff_DW_MNS", 0, path);
	this->m_Buff2 = GetPrivateProfileInt(section, "Buff_DK_GM", 0, path);
	this->m_Buff3 = GetPrivateProfileInt(section, "Buff_ELF_Thu", 0, path);
	this->m_Buff4 = GetPrivateProfileInt(section, "Buff_ELF_Dame", 0, path);
	this->m_Buff5 = GetPrivateProfileInt(section, "Buff_DL_ChiMang", 0, path);
	this->m_Buff6 = GetPrivateProfileInt(section, "Buff_SUM_PhanDame", 0, path);
	this->m_Buff7 = GetPrivateProfileInt(section, "Buff_RF_ThuLuc", 0, path);
	//this->m_Buff8 = GetPrivateProfileInt(section, "Buff_RF_XuyenThau", 0, path);
	//this->m_Buff9 = GetPrivateProfileInt(section, "Buff_RF_PhongThu", 0, path);
#endif
	this->m_BossDameCuoi = GetPrivateProfileInt(section, "BossDameCuoi", 0, path);
	...
	this->MemberOnlineSubSwitch = GetPrivateProfileInt(section, "MemberOnlineSubSwitch", 0, path);
	...
	this->BloodCSReward[0] = GetPrivateProfileInt(section, "BloodCSQuest", 0, path);
	this->BloodCSReward[1] = GetPrivateProfileInt(section, "BloodNumbersOfMonster", 0, path);

	this->DevilCSReward[0] = GetPrivateProfileInt(section, "DevilCSQuest", 0, path);
	this->DevilCSReward[1] = GetPrivateProfileInt(section, "DevilNumbersOfMonster", 0, path);

	this->ChaosCSReward[0] = GetPrivateProfileInt(section, "ChaosCSQuest", 0, path);
	this->ChaosCSReward[1] = GetPrivateProfileInt(section, "ChaosNumbersOfMonster", 0, path);
...
void CServerInfo::ReadCustomInfo(char* section,char* path)
{
	...
	this->m_AnnounceChaosMix = GetPrivateProfileInt(section, "NangCapChaosMix", 0, path);
	...
	GetPrivateProfileString(section, "NangCapChaosMix10", "", this->m_AnnounceChaosMix10, sizeof(this->m_AnnounceChaosMix10), path);
	GetPrivateProfileString(section, "NangCapChaosMix11", "", this->m_AnnounceChaosMix11, sizeof(this->m_AnnounceChaosMix11), path);
	GetPrivateProfileString(section, "NangCapChaosMix12", "", this->m_AnnounceChaosMix12, sizeof(this->m_AnnounceChaosMix12), path);
	GetPrivateProfileString(section, "NangCapChaosMix13", "", this->m_AnnounceChaosMix13, sizeof(this->m_AnnounceChaosMix13), path);
	GetPrivateProfileString(section, "NangCapChaosMix14", "", this->m_AnnounceChaosMix14, sizeof(this->m_AnnounceChaosMix14), path);
	GetPrivateProfileString(section, "NangCapChaosMix15", "", this->m_AnnounceChaosMix15, sizeof(this->m_AnnounceChaosMix15), path);
	GetPrivateProfileString(section, "NangCapChaosMixFailed", "", this->m_AnnounceChaosMixFailed, sizeof(this->m_AnnounceChaosMixFailed), path);
...
void CServerInfo::ReadSkillInfo(char* section,char* path)
{
	...
	this->m_DissableBuffClass = GetPrivateProfileInt(section, "DissableBuffClass", 0, path);
