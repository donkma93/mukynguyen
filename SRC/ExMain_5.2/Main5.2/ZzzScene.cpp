...
bool NewRenderLogInScene(HDC hDC)
{
	...
	if (CCameraMove::GetInstancePtr()->IsTourMode())
	{
		...
		RenderBitmap(BITMAP_LOG_IN + 17, gPosWide.x_GetAddPos + 15 + ((640.0f - 256) / 2), 25.0f, 256.0f * 0.8f, 128.0f * 0.8f);
	...
	IsToolKit.ThisFont(0, y - 7, 0xFFFFFFFF, 0, IsToolKit.GetPositionScreen(), 0, 3, GlobalText[454]);
