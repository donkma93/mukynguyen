...
IF NOT EXISTS (SELECT 1 FROM sys.indexes WHERE name = N'IX_cms_partner_sessions_partner')
  CREATE INDEX IX_cms_partner_sessions_partner ON cms.partner_sessions (partner_account, created_at DESC);
IF NOT EXISTS (SELECT 1 FROM sys.indexes WHERE name = N'UQ_cms_partner_sessions_code')
  CREATE UNIQUE INDEX UQ_cms_partner_sessions_code ON cms.partner_sessions (code);
IF NOT EXISTS (SELECT 1 FROM sys.indexes WHERE name = N'IX_cms_partner_claims_partner')
  CREATE INDEX IX_cms_partner_claims_partner ON cms.partner_claims (partner_account, claimed_at DESC);
IF NOT EXISTS (SELECT 1 FROM sys.indexes WHERE name = N'IX_cms_partner_claims_claimer_pkg')
  CREATE INDEX IX_cms_partner_claims_claimer_pkg ON cms.partner_claims (claimer_account, package_id, claimed_at DESC);
